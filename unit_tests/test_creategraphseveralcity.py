import unittest
import osmnx as ox
from function1 import create_graph_several_city
#Проверить, соответствует ли поведение функции `create_graph_several_city` ожиданиям при различных условиях ввода.
