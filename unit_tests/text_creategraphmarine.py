...
#Тестирование функции create_graph_marine на предмет того, может ли она правильно создавать новый морской граф при заданных входных данных,
# а также проверка того, соответствуют ли количество и атрибуты узлов и ребер этого графа ожиданиям.
